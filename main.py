...
TICKET_IMAGE_URL = os.getenv("TICKET_IMAGE_URL", "")  # optional direct image URL
...
def acquire_lock():
    """Create a process lock atomically and remove only stale locks."""
    try:
        ...
        try:
            ...
            # Broken lock file: remove it and retry once.
            try:
                os.remove(LOCK_FILE)
            except OSError:
                return False
