...
async def update_lobby_post(bot: Bot, lobby_id: int):
    ...
    text = (
        ...
        "\n——————\n"
        f"Карта будет определена через ban/pick после набора игроков."
    )
...
def init_lobbies():
    ...
    for mode, tid in [("5x5",TOPIC_REG_LOBBY_5x5),("5x5",TOPIC_REG_LOBBY_5x5),
                      ("2x2",TOPIC_REG_LOBBY_2x2),("2x2",TOPIC_REG_LOBBY_2x2),
                      ("1x1",TOPIC_REG_LOBBY_1x1),("1x1",TOPIC_REG_LOBBY_1x1)]:
